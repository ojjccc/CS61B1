...
class Date {
  ...
  public int dayInYear() {
    ...
    return days+this.day;// replace this line with your solution
  }
   ...
   */
  public int daysCal(Date d1, Date d2){
	  int days = 0;
	  for(int i=0;i<d1.year-d2.year;i++){
		  days+=new Date(12,31,d2.year+i).dayInYear();
	  }
	  return days-d2.dayInYear()+d1.dayInYear();
  }
  public int difference(Date d) {
    if(this.year==d.year)
    	return this.dayInYear()-d.dayInYear();
    else if(this.year<d.year) 
    	return -daysCal(d,this);
    else return daysCal(this,d);
  }
