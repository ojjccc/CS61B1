...
public class RunLengthEncoding implements Iterable {
   ...
   *  width * height.  (Feel free to quit with an e
   *  error message if any of these
  ...
  public PixImage toPixImage() {
    // Replace the following line with your solution.
	  PixImage runPixImage = new PixImage(imgwidth,imgheight);
  ...
  public String toString() {
    // Replace the following line with your solution.
	  ...
	  String s="";
	  while(runIterator.hasNext()){
		  s+="["+runIterator.next()[0]+","+runIterator.next()[1]+
				  ","+runIterator.next()[2]+","+runIterator.next()[3];
	  }
  ...
  public void check() {
	  ...
	  if (number!=imgheight*imgwidth){
		  System.out.println("Wrong Size");
          System.out.println(this);
          System.out.println(number + "!=" + imgwidth * imgheight);
          Thread.dumpStack();
          System.exit(0);
	  }
    // Your solution here.
